...
- `build_sim` — build the project after making changes to confirm compilation succeeds

# Core Operating Rules

## Before Writing Code

Do not write, edit, or generate code immediately.
...
Use a dedicated branch for each feature, bug fix, refactor, or task.

Prefer a separate Git worktree for every active task.
...
Create a shared `.worktree` folder under the project root.

All task worktrees must live there.
